...
### **The Drive folder contains the freshwater fish image dataset and the per-100g nutrition metadata CSV file.**
...
The main goal is to evaluate whether a MobileNetV2-based lightweight framework can provide a practical and robust solution for freshwater fish species recognition in Bangladesh-focused fish image data.
